...
{
    /* Source Image info */
    char *src_image_fname;  //store sorce image file name  ie beautiful.bmp
    FILE *fptr_src_image;    // address of sorce file
...
//Status dodecode(EncodeInfo *encInfo);
void get_help_main ();
